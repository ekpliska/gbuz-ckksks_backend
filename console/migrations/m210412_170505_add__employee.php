...
class m210412_170505_add__employee extends Migration
{
    ...
    public function safeUp()
    {
        ...
        $this->createTable('{{%employee}}', [
            ...
            'birth_place' => $this->string(256),
            'passport' => $this->string(20),
            'passport_info' => $this->string(256),
            'snils' => $this->string(20),
            'university_name' => $this->string(170),
            'year_ending' => $this->string(4),
            'qualification' => $this->string(256),
            'diploma_details' => $this->string(256),
            'document_type_id' => $this->integer(),
            'document_number' => $this->string(20),
            'date_preparation' => $this->dateTime(),
            'post_id' => $this->integer(),
            'description_number' => $this->string(),
            'employment_date' => $this->dateTime(),
